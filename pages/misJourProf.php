...
<div class="container">
   ...
   <form  action="coordonneProf.php?id_prof=<?= $coordoneProf['id_prof'] ?>" method="post" id="form-update"  enctype="multipart/form-data">
        <h1 class="text-center text-primary bg-info">Mise à jour des coordonnées de l'enseignant </h1>

            <div class="md-3">
                <label for="nomProf">Nom </label>
                <input type="text" class="form-control" id="nomProf" name="nomProf" placeholder="<?= $coordoneProf['nom_prof'] ?>" required>
            </div>

            <div class="md-3">
                <label for="prenomProf">Prenom </label>
                <input type="text" class="form-control" id="prenomProf" name="prenomProf" placeholder="<?= $coordoneProf['prenom_prof'] ?>" required>
            </div>

            <div class="md-3">
                <label for="dateDepot">Date de naissance</label>
                <input type="date" class="form-control" id="dateNaissance"  name="dateNaissance" placeholder="<?= $coordoneProf['date_naissance_prof'] ?>" required>
            </div>

            <div class="md-3">
                <label for="prixProduit">Age </label>
                <input type="number"  class="form-control" id="ageProf"  name="ageProf" placeholder="<?= $coordoneProf['age_prof'] ?>" required>
                
            </div>

            <div class="md-3">
                <label for="">Numéro de téléphone</label>
                <input type="tel"  class="form-control" id="telNo"  name="telNo" placeholder="<?= $coordoneProf['tel_prof'] ?>" required>
            </div>

            <div class="md-3">
                <label for="email"  ><b>Email</b></label>
                <input type="email" placeholder="<?= $coordoneProf['email_prof'] ?>" name="email" required>
            </div>

            <div class="md-3">
                <label for="prenomProf">Matiére</label>
                <input type="text" class="form-control" id="matierProf" name="matierProf" placeholder="<?= $coordoneProf['metier_prof'] ?>" required>
            </div>

            <div class="md-3">
                <label for="vaccinProf">Enseignant vacciné</label>
                <select class="form-control" id="etatProf" name="etatProf" placeholder="<?= $coordoneProf['etat_prof'] ?>" required>
            ...
            <div class="md-3">
                <label for="imageProf">Image du Produit</label>
                <input type="file" class="form-control" id="imageProf" name="imageProf" placeholder="<?= $coordoneProf['avatar_prof'] ?>" required>
            </div>
